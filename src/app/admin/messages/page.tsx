...
import Sidebar from "@/components/Sidebar"; // Sidebar bileşenini import etmeyi unutmayın
...
export default function AdminMessagesPage() {
  ...
  if (loading) {
    return (
      // Yükleme durumu için Sidebar entegrasyonu
      <div className="flex min-h-screen bg-gray-100">
        <Sidebar />
        <div className="flex-1 p-6 md:p-8 flex items-center justify-center">
          <div className="text-center text-gray-700">Mesajlar yükleniyor...</div>
        </div>
      </div>
    );
  }
  ...
  return (
    // Ana kapsayıcı div: Sidebar ve içerik için Flexbox
    <div className="flex min-h-screen bg-gray-100">
      {/* Sidebar bileşeni */}
      <Sidebar />
      ...
      <div className="flex-1 p-6 md:p-8">
        <div className="max-w-7xl mx-auto"> {/* Mevcut içeriği bu div içine sarıyoruz */}
